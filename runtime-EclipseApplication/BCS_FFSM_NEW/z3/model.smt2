...
(assert (and (or (and (and true ManPW) (and true CLS)) (and (and true AutPW) (and true CLS))) (and BCS DS PW FP WIN AutPW SEC CLS (not HMI) (not LED) (not LEDAS) (not LEDFP) (not LEDCLS) (not LEDPW) (not LEDEM) (not LEDH) (not ManPW) (not EM) (not ELE) (not HEAT) (not AS) (not IM) (not AL) (not RCK) (not CAS) (not SF) (not CAP) (not AEM) )))
(check-sat)
