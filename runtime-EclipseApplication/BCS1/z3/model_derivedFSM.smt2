...
(assert (and
 ...
 (assert (and BCS DS PW FP WIN ManPW (not HMI) (not LED) (not LEDAS) (not LEDFP) (not LEDCLS) (not LEDPW) (not LEDEM) (not LEDH) (not AutPW) (not EM) (not ELE) (not HEAT) (not SEC) (not AS) (not IM) (not CLS) (not AL) (not RCK) (not CAS) (not SF) (not CAP) (not AEM) ))(assert (and true true))
(assert (and 
