...
(assert (and
 ...
 (assert (and BCS DS PW FP WIN AutPW SEC CLS AL (not HMI) (not LED) (not LEDAS) (not LEDFP) (not LEDCLS) (not LEDPW) (not LEDEM) (not LEDH) (not ManPW) (not EM) (not ELE) (not HEAT) (not AS) (not IM) (not RCK) (not CAS) (not SF) (not CAP) (not AEM) ))(assert (and (and (and true true CLS) CLS) (and (and true true CLS) CLS)))
(assert (and 
