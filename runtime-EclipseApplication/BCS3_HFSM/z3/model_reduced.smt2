...
(assert (and (and CLS (and true CLS)) (and CLS (and true CLS))))
(assert (and 
    (not (and true (and CLS (and true CLS)) ManPW (and CLS (and true CLS)) ))
    (not (and true (and CLS (and true CLS)) AutPW (and CLS (and true CLS)) ))
))
(check-sat)