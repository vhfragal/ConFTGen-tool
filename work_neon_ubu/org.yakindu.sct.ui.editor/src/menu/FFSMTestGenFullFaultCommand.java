 ...
 * 
 */
public class FFSMTestGenFullFaultCommand extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		System.out.println("GENERATION FULL FAULT:::");
	...
	public void post_processing(Diagram diagram, String suite){
		...
		String file_path_states = project_path.concat(resource_path+"_full_fault.txt");
