 ...
 * 
 */
public class FSMDeriveModelCommand extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (activeEditor instanceof StatechartDiagramEditor) {
			...
			try {
				...
				HashMap<String, ArrayList<String>> map = val.getDerivationMAP(diagram, true);
	...
	public void post_processing(Diagram diagram, String suite, String fmodel){
		...
		String file_path_states = project_path.concat(resource_path+"_derivedFSM.ffsm");
		String file_path_fm = project_path.concat(resource_path+"_derivedFSM.xml");
