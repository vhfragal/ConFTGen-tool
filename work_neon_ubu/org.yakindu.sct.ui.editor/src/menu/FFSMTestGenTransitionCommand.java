 ...
 * 
 */
public class FFSMTestGenTransitionCommand extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		System.out.println("GENERATION TRANSITION:::");
		...
		if (activeEditor instanceof StatechartDiagramEditor) {
			...
			try {
				...
				p.genTransitionSuite();
				String suite =  p.getTransitionSuite();
				post_processing(diagram, suite);
			} catch (Exception e) {
	...
	public void post_processing(Diagram diagram, String suite){
		...
		resource_path = resource_path + "/suites/"+diagram_name;
		
		String file_path_states = project_path.concat(resource_path+"_transitions.txt");
