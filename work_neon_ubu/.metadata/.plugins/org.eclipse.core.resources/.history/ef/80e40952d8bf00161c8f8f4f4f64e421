...
public class SimpleNode_backup implements Node {
	...
	public SimpleNode_backup(int i) {
		id = i;
	}

	public SimpleNode_backup(FCONSTRAINT p, int i) {
		this(i);
		parser = p;
	}
	...
	public void dump(String prefix) {
		...
		if (children != null) {
			for (int i = 0; i < children.length; ++i) {
				SimpleNode_backup n = (SimpleNode_backup) children[i];
				if (n != null) {
					n.dump(prefix + " ");
				}
			}
